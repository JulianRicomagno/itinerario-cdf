...
export default function CreateItineraty(props) {
  ...
  const pressEnd = () => {
    if (selectedStartDate != null && selectedEndDate != null) {
      ...
      while (i < totalDays) {
        arr.push({
          attendanceDate: momentArray.add(x, "days").format("yyyy-MM-DD"),
          isDayOff: false,
          attractions: [],
        });
        if (x == 0) {
  ...
  function checkCompleted() {
    ...
    return (
      place !== "Seleccionar tipo de estadía" &&
      place !== null &&
      ...
      <View style={styles.container}>
        ...
        <View>
          <View style={styles.picker}>
            <RNPickerSelect
              placeholder={{
                label: "Seleccionar tipo de estadía",
                value: "Seleccionar tipo de estadía",
              }}
              items={[
          ...
          <View style={styles.bottom}>
            <TouchableOpacity
              ...
              style={[
                styles.button,
                {
                  backgroundColor: completed ? "#32BB77" : "#C8C7C6",
                  borderColor: completed ? "#32BB77" : "#FFFFFF",
                },
              ]}
            >
              <Text
